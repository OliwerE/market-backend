...
export class AuthController {
  ...
  getCsrfToken (req, res, next) {
    ...
    res.cookie('XSRF-TOKEN', req.csrfToken(), { secure: true, sameSite: 'lax', domain: 'http://localhost:3000' }) // prod: { secure: true, sameSite: 'lax', domain: '.market-client-1dv613.netlify.app' } dev: { secure: false, sameSite: 'lax' }
    res.json({})
  }
