...
export class AuthController {
  ...
  getCsrfToken (req, res, next) {
    ...
    res.status(200)
    res.cookie('XSRF-TOKEN', req.csrfToken(), { secure: true, sameSite: 'none', domain: '.market-client-1dv613.netlify.app' }) // prod: { secure: true, sameSite: 'lax', domain: '.market-client-1dv613.netlify.app' } dev: { secure: false, sameSite: 'lax' }
    res.json({})
  }
