...
export class AuthController {
  ...
  getCsrfToken (req, res, next) {
    ...
    res.cookie('XSRF-TOKEN', req.csrfToken(), { secure: true, sameSite: 'lax', domain: 'localhost' }) // prod: { secure: true, sameSite: 'lax', domain: '.market-client-1dv613.netlify.app' } dev: { secure: false, sameSite: 'lax' }
    res.json({})
  }
